<div class="min-h-screen bg-gray-50 dark:bg-neutral-900 rounded">
    <!-- header -->
    <div class="bg-indigo-700 dark:bg-indigo-900 shadow-xl border-b-4 border-blue-400 rounded-b-2xl relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
            <div class="flex items-center gap-4">
                ...
                <svg class="w-10 h-10 text-white drop-shadow-lg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                </svg>

                <div class="flex flex-1 items-start justify-between gap-4">
                    <div>
                        <h1 class="text-4xl font-extrabold text-white drop-shadow-lg tracking-tight">Budgets</h1>
                        <p class="text-yellow-100 mt-2 italic text-lg">Plan and track your spending limits</p>
                    </div>
        ...
        <div class="absolute inset-0 bg-white/5 opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="/budgets/create"
                class="bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition"
                ...
                <!-- Card Header -->
                <div class="p-6 {{ $budget->category ? '' : 'bg-gray-600' }}"
                    @if($budget->category)
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-2xl font-bold text-gray-900 dark:text-gray-100">${{ number_format($budget->amount, 2) }}</span>
                    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-12 text-center">
            ...
            <a href="/budgets/create"
                class="inline-flex items-center gap-2 bg-indigo-600 text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                </svg>
