...
<body class="min-h-screen bg-stone-50 text-stone-900 antialiased dark:bg-neutral-950 dark:text-stone-100">
    <div class="relative overflow-hidden">
        <div class="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_right,_#fbbf24_0%,_transparent_40%),radial-gradient(circle_at_20%_20%,_#14b8a6_0%,_transparent_35%),linear-gradient(180deg,_#fffbeb_0%,_#f5f5f4_60%,_#fafaf9_100%)] dark:bg-[radial-gradient(circle_at_top_right,_#78350f_0%,_transparent_45%),radial-gradient(circle_at_20%_20%,_#0f766e_0%,_transparent_35%),linear-gradient(180deg,_#0a0a0a_0%,_#171717_60%,_#0f0f0f_100%)]"></div>
        ...
        <main class="mx-auto grid max-w-6xl gap-10 px-6 pb-20 pt-8 lg:grid-cols-2 lg:items-center lg:px-8">
            <section>
                ...
                <div class="mt-8 flex flex-wrap items-center gap-3">
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="rounded-xl bg-amber-500 px-6 py-3 text-sm font-bold text-stone-950 shadow-xl shadow-amber-900/20 transition hover:bg-amber-400">
                            Create Free Account
                        </a>
                    @endif
            ...
            <section class="grid gap-4">
                ...
                <article class="rounded-2xl border border-stone-200 bg-gradient-to-r from-teal-600 to-cyan-600 p-6 text-white shadow-lg shadow-cyan-900/20">
